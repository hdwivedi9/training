  ...
  renderLookupFilter = (columnDef) => (
    <FormControl style={{ width: '100%' }}>
      ...
      <Select
        ...
        input={<Input id="select-multiple-checkbox" style={{color:'#ffffff8a', margin:'0'}}/>}
  ...
  renderDefaultFilter = (columnDef) => {
    ...
    return (
      <TextField
        ...
        InputProps={{
          startAdornment: (
            <InputAdornment position="start" style={{color:'#ffffff8a'}}>
    ...
    if (columnDef.type === 'datetime') {
      dateInputElement = (
        <DateTimePicker
          ...
          onChange={onDateInputChange}
          clearable
          autoOk allowKeyboardControl emptyLabel='Pick a max due date' maxDateMessage='' minDateMessage=''
          InputProps={{style:{color:'#ffffff8a'}}}
        />
      );
    }
